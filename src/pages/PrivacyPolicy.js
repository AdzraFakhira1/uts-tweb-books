...
export default function PrivacyPolicy() {
  return (
    <div id="privacypolicy" className="container mx-auto bg-white py-8 p-5">
      <h1>Privacy Policy for Books</h1>

      <p>
        At Books, accessible from books.test, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Books and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Books. This policy is not applicable to any
      ...
      <p>
        Books follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Books uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of Books.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Books, which are sent directly
      ...
      <p>
        Note that Books has no access to or control over these cookies that are
      ...
      <p>
        Books's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Books does not knowingly collect any Personal Identifiable Information
